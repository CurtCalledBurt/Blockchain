...
def mine():
    ...
    # check if both and id and a proof is included in the response
    if 'proof' not in data or 'id' not in data:
        response = {'message': "Proof or Id missing from post request"}
    ...
    if blockchain.valid_proof(last_block_string, proof):
        # reward person who found a valid proof
